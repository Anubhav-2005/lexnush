...
class LexNushAppTests(unittest.TestCase):
    ...
    def test_home_uses_editorial_experience_without_redundant_final_cta(self):
        ...
        self.assertIn(b"ep-5-picking-the-referee", homepage.data)
        ...
        self.assertIn(b"Ep. 4 \xe2\x80\x9cStarting the Clock\xe2\x80\x9d", law_explained)
    ...
    def test_sitemap_and_robots_use_public_url(self):
        ...
        self.assertIn("http://testserver/judgment-explained/", sitemap)
